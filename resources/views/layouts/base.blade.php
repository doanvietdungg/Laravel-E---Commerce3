...
<li class="menu-item menu-item-has-children parent" >
    ...
    <ul class="submenu curency" >
        ...
        <li class="menu-item" >
            <a title="Dashboard" href="{{ route('user.MyAccount') }}">My Account</a>
        </li>
        <li class="menu-item" >
            <a title="Dashboard" href="{{ route('user.Order') }}">All Order</a>
        </li>
        <li  class="menu-item">
            <a  href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
        </li>
					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								<li class="menu-item  @yield('class-home')">
									<a href="/" class="link-term mercado-item-title"><i class="fa fa-home" aria-hidden="true"></i></a>
								</li>
								<li class="menu-item @yield('class-about') ">
									<a href="/About" class="link-term mercado-item-title">About Us</a>
								</li>
								<li class="menu-item  @yield('class-shop')">
									<a href="/Shop" class="link-term mercado-item-title">Shop</a>
								</li>
								<li class="menu-item  @yield('class-cart')">
									<a href="/Cart" class="link-term mercado-item-title">Cart</a>
								</li>
								<li class="menu-item  @yield('class-checkout')">
									<a href="/Checkout" class="link-term mercado-item-title">Checkout</a>
								</li>
								<li class="menu-item  @yield('class-contact')">
