                   ...
                   <div class="panel-body">
                       ...
                       <form action="" class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="addProduct">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="" class="form-control input-md" placeholder="Product-name" type="text"  wire:model="product_name" wire:keyup="generateSlug">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4" wire:ignore>
                                <textarea name="short-des" id="short_des" class="form-control" placeholder="short desciption" wire:model="short_des" ></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4" wire:ignore>
                                <textarea name="des" id="description" class="form-control" placeholder="desciption" wire:model="description" ></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="" class=" input-file" type="file"  name="img" wire:model="image">
                                @error('description') <span class="error text-danger">{{ $message }}</span> @enderror
                                @if ($image)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="" class=" input-file" type="file"  name="img" wire:model="images" multiple>
                                @error('description') <span class="error text-danger">{{ $message }}</span> @enderror
                                @if($images)
      ...
      $(function(){
          tinymce.init({
              ...
              setup:function(editor){
                  editor.on('Change',function(e){
                        tinyMCE.triggerSave();
                        var data=$('#short_des').val();
                        @this.set('short_des',data);
                  });
              }
          });
          ...
          tinymce.init({
            ...
            setup:function(editor){
                editor.on('Change',function(e){
                      tinyMCE.triggerSave();
                      var data_d=$('#description').val();
                      @this.set('description',data_d);
                });
            }
        });
      });
