                            ...
                            <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
								<div class="product product-style-3 equal-elem ">
									...
									<div class="product-info">
										...
										<a href="#" class="btn add-to-cart" wire:click.prevent="stored({{ $item->id }},'{{ $item->name }}',{{ $item->regular_price }})">Add To Cart</a>
                                        <div class="product-wish">
                                            @if ($witems->contains($item->id))
                                            <a href="#"  wire:click.prevent="removeWishlist({{ $item->id }})"><i class="fa fa-heart fill-heart"></i></a>
                                            @else
                                            <a href="#"  wire:click.prevent="AddWishlist({{ $item->id }},'{{ $item->name }}',{{ $item->regular_price }})"><i class="fa fa-heart"></i></a>
                                            @endif
						...
						<div class="widget-content">
							<ul class="list-category">
                                ...
                                <li class="category-item has-child-cate">
									<a href="/Product_Category/{{ $item->slug }}" class="cate-link">{{ $item->name }}</a>
